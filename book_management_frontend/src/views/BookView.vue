          ...
          <el-row>
            <el-col :span="24">
              ...
              <el-drawer v-model="showDrawer">
                <template #header><h1>借阅</h1></template>
              ...
              >
                <el-form :inline="true" v-if="detail">
                  ...
                  <el-form-item label="库存量">{{ book.number }}</el-form-item>
                  <el-form-item label="ISBN">{{ book.isbn }}</el-form-item>
                  <el-form-item label="入库日期">{{ book.entryDate ? book.entryDate.substring(0, 10) : '-' }}</el-form-item>
                </el-form>

                <el-form v-if="detail">
                  <el-form-item label="简介">
                    <el-input v-model="book.introduction" :autosize="{ minRows: 2, maxRows: 6 }" type="textarea" readonly />
                  </el-form-item>
                </el-form>
              </el-dialog>
            </el-col>
